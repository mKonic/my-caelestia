-- Material You scheme — values mirror scheme/default.conf $var=hex pairs.
-- `caelestia scheme set` overwrites scheme/current.lua at runtime; this file
-- is the fallback. See scheme/loader.lua.
